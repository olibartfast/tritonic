...
public:
    ...
    const std::string& GetBackend() const noexcept {
        return backend_;
    }
    void SetBackend(const std::string& v) {
        backend_ = v;
    }
    const std::string& GetApiEndpoint() const noexcept {
    ...
    void SetApiKeyEnv(const std::string& v) {
        api_key_env_ = v;
    }
    int GetTargetImageSize() const noexcept {
        return target_image_size_;
    }
    void SetTargetImageSize(int v) noexcept {
        target_image_size_ = v;
    }
    bool GetInteractive() const noexcept {
        return interactive_;
    }
    void SetInteractive(bool v) noexcept {
        interactive_ = v;
    }
